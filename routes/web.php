...
Route::get('cookiespolicy', [HomeController::class, 'cookiespolicy'])->name('cookiespolicy');
Route::get('contact', [HomeController::class, 'contact'])->name('contact');

// Service worker fallback route (for cached service workers trying to access /public/serviceworker.js)
Route::get('/public/serviceworker.js', function () {
