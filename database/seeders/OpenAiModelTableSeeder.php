...
class OpenAiModelTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('open_ai_models')->insert(array(
            ...
            array('id' => '12', 'name' => 'Claude 3 Opus', 'key' => 'claude-3-opus-20240229', 'order' => 1, 'created_at' => NULL, 'updated_at' => NULL, 'deleted_at' => NULL),
            array('id' => '13', 'name' => 'Claude 3.5 Sonnet', 'key' => 'claude-3-sonnet-20240229', 'order' => 1, 'created_at' => NULL, 'updated_at' => NULL, 'deleted_at' => NULL),
            array('id' => '14', 'name' => 'DeepSeek V3', 'key' => 'deepseek-chat', 'order' => 1, 'created_at' => NULL, 'updated_at' => NULL, 'deleted_at' => NULL),
        ));
    }
}
