<table>
    <thead>
        <tr>
            <th colspan="4" style="background-color: #4472C4; color: white; font-weight: bold; text-align: center; padding: 10px;">
                Role-Based Goals Export
            </th>
        </tr>
        @if($goal)
        <tr>
            <th colspan="4" style="background-color: #E7E6E6; padding: 8px;">
