                                ...
                                <input type="hidden" name="reset_with" class="reset_with" value="email">
                                    <div class="form-group position-relative w-100">
                                        <label>Email Address</label>
                                         <input type="email" class="form-control" placeholder="{{ localize('your@email.com') }}"
                                    id="email" @if (old('reset_with') != 'phone') required @endif aria-label="email"
                                    name="email" value="{{ old('email') }}">
                                    </div>
                                    
                
                                    <button type="submit" class="btn btn-md btn-blue mt-3 d-block w-100 sign-in-btn"
                            onclick="handleSubmit()">{{ localize('Send Instructions') }}</button>
                                </form>
                            </div>
