{{-- Shared chrome for the split auth pages: login, register and verify.
     These three carried byte-identical copies of this stylesheet; the order
     matters, the Bootstrap CDN loads after the block so it can still win. --}}
<style>
