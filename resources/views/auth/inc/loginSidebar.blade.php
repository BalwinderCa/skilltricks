...
<style>
    #login-form .row .col-12.mb-2,
    #login-form .row .col-12.mb-3 button {color:#000 !important}
</style>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-10 col-md-12">
                <div class="testimonial-tab-slider-wrap text-center mt-5">
                    ...
                    Unlock Your True Potential with SkillTricks
                   <br><span class="tt-text-gradient-primary">
                   Master industry-relevant skills with guided courses, expert mentorship, and real-world projects.
                            </span>
                    </h1> 
                    <!-- <h1 class="fw-bold text-white display-6">
                    ...
                    <div class="swiper custom-swiper mt-4 d-none"
                        data-swiper='{
                        "slidesPerView": 4,
