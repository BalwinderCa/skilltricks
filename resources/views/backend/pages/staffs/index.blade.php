                    ...
                    <div class="tt-page-header">
                        <div class="d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title mb-3 mb-lg-0">
                                <h1 class="h4 mb-lg-1">{{ localize('Employee Staffs') }}</h1>
                                <ol class="breadcrumb breadcrumb-angle text-muted">
                                    ...
                                    <li class="breadcrumb-item">{{ localize('New Employee') }}</li>
                                </ol>
                            </div>
                            <div class="tt-action">
                                @can('add_staffs')
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-breakpoints="xs sm">{{ localize('Created By') }}</th>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @can('edit_staffs')
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.staffs.edit', ['id' => $staff->id, 'lang_key' => config('custom.default_language')]) }}">
