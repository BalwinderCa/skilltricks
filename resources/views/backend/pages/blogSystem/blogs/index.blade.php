                        ...
                        <form class="app-search" action="{{ Request::fullUrl() }}" method="GET">
                            <div class="card-header border-bottom-0">
                                <div class="row justify-content-between g-3">
                                    ...
                                    @php
                                        $isWizardBlog = request()->is_wizard_blog ?? null;
                                    @endphp

                                    <div class="col-auto">
                                        <div class="input-group">
                                            <select class="form-select " name="is_wizard_blog"
                                                    data-minimum-results-for-search="Infinity">

                                                <option value="">{{ localize("Select Blog Create Type") }}</option>

                                                <option value="2" @if($isWizardBlog && $isWizardBlog == 2) selected @endif>{{ localize('Manual') }}</option>
                                                <option value="1" @if($isWizardBlog && $isWizardBlog == 1) selected @endif>{{ localize('Ai Blog Wizard') }}</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-breakpoints="xs sm">{{ localize('Generated By') }}</th>
