...
{
    return view('frontend.new-theme.index');
}

public function about()
{
    return view('frontend.new-theme.about');
}
public function terms()
{
    return view('frontend.new-theme.terms');
}
public function services()
{
    return view('frontend.new-theme.services');
}
public function products()
{
    return view('frontend.new-theme.products');
}
public function privacypolicy()
{
    return view('frontend.new-theme.privacypolicy');
}
public function cookiespolicy()
{
    return view('frontend.new-theme.cookiespolicy');
}
public function contact()
{
    return view('frontend.new-theme.contact');
}
